...
const I18N = {
  fr: {
    ...
    form_name:'Nom', form_email_field:'Email', form_subject:'Sujet',
    form_subj1:'Rejoindre LIBER', form_subj2:'Informations sur les ateliers',
    form_subj3:'Réserver un spectacle / tournée', form_subj4:'Autre',
    form_message:'Message', form_send:'Envoyer le message 🚀',
    form_success:'Message envoyé ! Nous vous répondrons très bientôt.',
    /* Newsletter */
...
Friedrichstr. 219, 10969 Berlin — <a href="https://www.datenschutz-berlin.de" target="_blank" rel="noopener">datenschutz-berlin.de</a></p>`,
  ...
  de: {
    ...
    form_name:'Name', form_email_field:'E-Mail', form_subject:'Betreff',
    form_subj1:'LIBER beitreten', form_subj2:'Infos zu Workshops',
    form_subj3:'Aufführung / Tournee buchen', form_subj4:'Sonstiges',
    form_message:'Nachricht', form_send:'Nachricht senden 🚀',
    form_success:'Nachricht gesendet! Wir melden uns sehr bald.',
    /* Newsletter */
    newsletter_title:'Newsletter',
