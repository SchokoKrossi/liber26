...
let voucherOpen = false;     // hidden by default — admin enables it
let voucherUrl  = 'https://www.yesticket.org/events/de/liber-ligue-dimpro-de-berlin/';
...
const _showToDB    = j => ({
  ...
  title_fr:j.titleFR, title_de:j.titleDE,
...
const KEY_NEWSLETTER_OPEN  = '__newsletter_open';
const KEY_VOUCHER_OPEN     = '__voucher_open';
const KEY_VOUCHER_URL      = '__voucher_url';
...
function _applyContentRow(row) {
  ...
  switch (key) {
    ...
    case KEY_NEWSLETTER_OPEN:  newsletterOpen    = value_fr !== 'false';           return;
    case KEY_VOUCHER_OPEN:     voucherOpen       = value_fr === 'true';            return;
    case KEY_VOUCHER_URL:      if (value_fr) voucherUrl = value_fr;                return;
  }
...
function applyContentSingletons() {
  ...
  // Newsletter signup box visibility on the contact page
